...
public class UpdateSearchTest {
  ...
  private JSONObject getGeoJSON()
  {
	  ...
	  GlobalCoordinate e1 = new GlobalCoordinate(-90, -180);
	  GlobalCoordinate e2 = new GlobalCoordinate(-90, 180);
	  GlobalCoordinate e3 = new GlobalCoordinate(90, 180);
	  GlobalCoordinate e4 = new GlobalCoordinate(90, -180);
		list.add(e1);
		list.add(e2);
		list.add(e3);
		list.add(e4);
