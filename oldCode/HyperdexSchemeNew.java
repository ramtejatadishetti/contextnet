...
public class HyperdexSchemeNew<NodeIDType> extends AbstractScheme<NodeIDType>
{
				...
				processQueryMsgFromUser(QueryMsgFromUser<NodeIDType> queryMsgFromUser)
		{
			...
			ContextServiceLogger.getLogger().fine("QUERY RECVD QUERY_MSG recvd query recvd userReqId "+userReqID
				...
				throws HyperDexClientException
		{
			...
			ContextServiceLogger.getLogger().fine("VersionNum "+versionNum+" addGroupLen "+addedToGroups.length()
