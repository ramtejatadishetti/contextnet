...
public class PhoneCaseStudyExample extends ContextServiceNode<Integer>
{
	...
	public static void main(String[] args) throws NumberFormatException, UnknownHostException, IOException
	{
		...
		nodes = new PhoneCaseStudyExample[csNodeConfig.getNodeIDs().size()];
	...
	private static class StartNode implements Runnable
	{
		...
		public void run()
		{
			try
			{
				nodes[myIndex] = new PhoneCaseStudyExample(nodeID, csNodeConfig);
	...
	{
		private final PhoneCaseStudyExample csObj;
		
		public NumMessagesPerSec(PhoneCaseStudyExample csObj)
		{
			this.csObj = csObj;
		}
