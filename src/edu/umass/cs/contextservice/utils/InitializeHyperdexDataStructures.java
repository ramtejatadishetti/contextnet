...
public class InitializeHyperdexDataStructures
{
	...
	public static void main(String[] args)
	{
		...
		for(int i=0; i<numAttrs; i++)
		{
			...
			System.out.println("Initializing attribute "+i);
			...
			while(start <= AttributeTypes.MAX_VALUE )
			{
				...
				try 
				{
					...
					System.out.println("Entry put in "+keySpaceName);
					...
					System.out.println("Entry put in "+HyperdexSchemeNew.RANGE_KEYSPACE);
