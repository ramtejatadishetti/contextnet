...
public class NationWideWorkloadAwareRegionMappingPolicy extends AbstractRegionMappingPolicy
{
	...
	private static final String UPDATE_TRACE_FILE			= "traces/nationwidepopulationtrace/updateFile.txt";
	
	private final LinkedList<RegionInfo> regionList;
	
	
	public NationWideWorkloadAwareRegionMappingPolicy(HashMap<String, AttributeMetaInfo> attributeMap, 
...
//										attributeMap, nodeConfig.getNodeIDs().size() );	
		...
		System.out.println("Update JFI "+ujfi);
...
//		attrList.add(attrInfo.getAttrName());
		...
		for(int n=0; n<nodeList.length; n++)
		{
			...
			NationWideWorkloadAwareRegionMappingPolicy obj 
					= new NationWideWorkloadAwareRegionMappingPolicy(givenMap, csNodeConfig);
