...
/**
 * database record for storing Attribute value information, range and associated GUIDs.
 * Keys for the record is RANGE_START, RANGE_END pair
 * @author adipc
 *
 */
public class ValueInfoObjectRecord<AttributeType>
{
	public static enum Keys {RANGE_START, RANGE_END, NODE_GUID_LIST};
	...
	private final JSONArray nodeGUIDList;
	
	
	// primary key is in the form of JSON like { "$oid" : "546f092044ae941f7e5157a7"}
	private JSONObject primaryKeyJSON = null;
	
	public ValueInfoObjectRecord(Double rangeStart, Double rangeEnd, 
			JSONArray nodeGUIDList)
	{
	...
	public JSONObject toJSONObject() throws JSONException
	{
		...
		json.put(Keys.NODE_GUID_LIST.toString(), this.nodeGUIDList);
		return json;
	}
	
	public ValueInfoObjectRecord(JSONObject json) throws JSONException
	{
		this.rangeStart = json.getDouble(Keys.RANGE_START.toString());
		this.rangeEnd = json.getDouble(Keys.RANGE_END.toString());
		//this.nodeGUIDList = json.getJSONArray(Keys.NODE_GUID_LIST.toString());
		this.nodeGUIDList = new JSONArray(json.getString(Keys.NODE_GUID_LIST.toString()));
		//json.getJSONArray(Keys.NODE_GUID_LIST.toString());
	...
	public JSONArray getNodeGUIDList()
	{
		return this.nodeGUIDList;
	}
