...
public class QuerySendVaryingAttributes<NodeIDType> implements InterfacePacketDemultiplexer<JSONObject>
{
	...
	public QuerySendVaryingAttributes(NodeIDType id) throws IOException
	{
		readNodeInfo();
	...
	public static void main(String[] args) throws IOException
	{
		...
		ContextServiceConfig.NUM_ATTRIBUTES = NUM_ATTRs;
		
		QuerySendVaryingAttributes<Integer> basicObj 
											= new QuerySendVaryingAttributes<Integer>(clientID);
		...
		while(true)
		{
			...
			for(int i=0;i<15;i++)
			{
		    	...
		    	if(startNumAttr>ContextServiceConfig.NUM_ATTRIBUTES)
		    	{
		    		startNumAttr = ContextServiceConfig.NUM_ATTRIBUTES;
		    	}
			}
		}
	}
