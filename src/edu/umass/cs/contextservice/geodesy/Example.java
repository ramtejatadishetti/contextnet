package edu.umass.cs.contextservice.geodesy;
...
public class Example {
  ...
  static void TwoDimensionalDirectCalculation() {
    ...
    ContextServiceLogger.getLogger().fine("Travel from Lincoln Memorial at 51.767921 deg for 6179.016 km");
  ...
  static void TwoDimensionalCalculation() {
    ...
    ContextServiceLogger.getLogger().fine("2-D path from Lincoln Memorial to Eiffel Tower using WGS84");
    System.out.printf(
  ...
  static void ThreeDimensionalCalculation() {
    ...
    ContextServiceLogger.getLogger().fine("3-D path from Pike's Peak to Alcatraz Island using WGS84");
    System.out.printf(
