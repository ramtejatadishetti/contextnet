...
public class UpdateSendVaryingAttributes<NodeIDType> implements InterfacePacketDemultiplexer<JSONObject>
{
	...
	public UpdateSendVaryingAttributes(NodeIDType id) throws IOException
	{
		readNodeInfo();
	...
	public static void main(String[] args) throws IOException
	{
		...
		UpdateSendVaryingAttributes<Integer> basicObj 
									= new UpdateSendVaryingAttributes<Integer>(clientID);
