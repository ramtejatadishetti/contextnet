...
public class GUIDAttrValueProcessingForNoPrivacy<NodeIDType> implements 
								GUIDAttrValueProcessingInterface<NodeIDType>
{
	...
	public GUIDAttrValueProcessingForNoPrivacy( NodeIDType myID, HashMap<Integer, Vector<SubspaceInfo<NodeIDType>>> 
					...
					throws JSONException
	{
		...
		valueUpdateToSubspaceRegionMessage 
				= new ValueUpdateToSubspaceRegionMessage<NodeIDType>( myID, 
							...
							unsetAttrsJSON, updateAttrJSON, PrivacySchemes.NO_PRIVACY.ordinal() );
