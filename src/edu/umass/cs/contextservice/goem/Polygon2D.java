...
//    }
  ...
  public Polygon2D notIntersection(Polygon2D poly) {
    ...
    //ContextServiceLogger.getLogger().fine("isEmpty " + thisArea.isEmpty());	
    //ContextServiceLogger.getLogger().fine("isPolygonal " + thisArea.isPolygonal());	
    thisArea.subtract(polyArea);
    //ContextServiceLogger.getLogger().fine("after isEmpty " + thisArea.isEmpty());	
    //ContextServiceLogger.getLogger().fine("after isPolygonal " + thisArea.isPolygonal());	
  ...
  public double percentNotIntersection(Polygon2D poly) {
    ...
    //ContextServiceLogger.getLogger().fine(" " + it + " / " + this.area() + " = " + res);
    return res;
  }
    ...
    while (pi.isDone() == false) {
      ...
      switch (type) {
        case PathIterator.SEG_MOVETO:
          //ContextServiceLogger.getLogger().fine("move to " + coordinates[0] + ", " + coordinates[1]);
          points.add(new java.lang.Double(coordinates[0]));
          points.add(new java.lang.Double(coordinates[1]));
          break;
        case PathIterator.SEG_LINETO:
          //ContextServiceLogger.getLogger().fine("line to " + coordinates[0] + ", " + coordinates[1]);
          points.add(new java.lang.Double(coordinates[0]));
          points.add(new java.lang.Double(coordinates[1]));
          break;
        case PathIterator.SEG_QUADTO:
          //ContextServiceLogger.getLogger().fine("quadratic to " + coordinates[0] + ", " + coordinates[1] + ", "
          //	   + coordinates[2] + ", " + coordinates[3]);
          break;
        case PathIterator.SEG_CUBICTO:
          //ContextServiceLogger.getLogger().fine("cubic to " + coordinates[0] + ", " + coordinates[1] + ", "
          //	   + coordinates[2] + ", " + coordinates[3] + ", " + coordinates[4] + ", " + coordinates[5]);
          break;
        case PathIterator.SEG_CLOSE:
          //ContextServiceLogger.getLogger().fine("close");
          break;
        default:
          break;
      }
